        ...
        <div className="container h-full">
          <div className="flex flex-col items-center space-y-4 text-center p-8 md:p-2 w-full">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter lg:text-6xl/none text-white px-10">
                Comprehensive Fleet Management Services – Starting at Just
                $49/Week
              </h1>
              <p className="mx-auto max-w-[700px] text-white md:text-xl font-bold">
              Your Partner in Mobility, Design and Support.
              </p>
            </div>
            ...
            <div className="grid grid-rows-2 md:grid-cols-2 gap-2 w-full md:w-fit p-5">
              ...
              <Link href={'#about-us'} className="py-2 px-5 rounded-full text-white bg-brand_blue font-bold">Learn More</Link>
            </div>
          </div>
        </div>
      </div>
